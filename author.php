<?php ordino_bunch_global_variable(); 
	...
	$layout = ordino_set( $settings, 'author_page_layout', 'right' );
	$sidebar = ordino_set( $settings, 'author_page_sidebar', 'blog-sidebar' );
	$view = ordino_set( $settings, 'author_page_view', 'list' );
	...
	$bg = ordino_set($settings, 'author_page_header_img');
	$title = ordino_set($settings, 'author_page_header_title');
?>
<!--Page Title-->

<?php if(!ordino_set($options, 'athr_banner')):?>
